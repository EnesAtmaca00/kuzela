    ...
    root.innerHTML = `
      <style>
        ...
        *{box-sizing:border-box}html{scroll-behavior:smooth}a{color:inherit;text-decoration:none}img{display:block;width:100%}h1,h2,h3,p{margin-top:0}.site{overflow:hidden;background:var(--paper)}.wrap{width:min(100% - 48px,1440px);margin-inline:auto}
        ...
        .hero{position:relative;min-height:910px;display:grid;align-items:end;margin-top:-84px;padding:150px clamp(24px,5vw,80px) 70px;color:var(--white);background:linear-gradient(90deg,rgba(9,10,8,.9),rgba(9,10,8,.62) 45%,rgba(9,10,8,.12) 78%),linear-gradient(180deg,transparent 55%,rgba(9,10,8,.72)),url('https://static.wixstatic.com/media/7279ae_52a6f8b25760418c9a5e142710023d92~mv2.jpg') 64% center/cover no-repeat}.hero-content{position:relative;z-index:1;max-width:1120px}.eyebrow{margin:0 0 22px;font-size:12px;font-weight:850;letter-spacing:.12em;text-transform:uppercase}
